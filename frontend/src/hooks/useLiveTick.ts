...
// tick when hundreds of instruments are subscribed. 120ms keeps the UI
// feeling live (Kite itself only pushes ~1 update/sec/instrument) while
// still coalescing bursts.
export function useLiveTicks(symbols: string[], flushMs = 120) {
