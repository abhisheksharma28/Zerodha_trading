...
CANONICAL: dict[str, CanonicalConfig] = {
    ...
    "macd-grid": _daily("macd-grid"),
    "zscore-regime-mr": _daily("zscore-regime-mr"),
    "triple-screen": _daily("triple-screen"),
    "elder-force-index": _daily("elder-force-index"),
    "supertrend": _daily("supertrend"),
    "golden-cross": _daily("golden-cross"),
    "rsi2-reversion": _daily("rsi2-reversion"),
    "bollinger-reversion": _daily("bollinger-reversion"),
    "fiftytwo-week-high": _daily("fiftytwo-week-high"),
    "dual-momentum": _daily("dual-momentum"),
